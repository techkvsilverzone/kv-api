      ...
      schemas: {
        ...
        Product: {
          ...
          properties: {
            ...
            material: { type: 'string', description: 'Free-text spec (e.g. metal/purity blend); not the taxonomy category', example: 'Silver' },
            category: { type: 'string', description: 'Top-level taxonomy category', example: 'Jewellery' },
            subcategory: { type: 'string', description: 'Only set for categories with children (currently Jewellery)', example: 'Mens' },
            tags: { type: 'array', items: { type: 'string' }, description: 'Optional free-text tags, also filterable' },
            weight: { type: 'number', description: 'Grams. Optional/0 for fixed-price products.', example: 10 },
        ...
        ProductInput: {
          ...
          properties: {
            name: { type: 'string', example: 'Silver Lotus Ring' },
            material: { type: 'string', description: 'Free-text spec, e.g. metal/purity blend', example: 'Silver' },
            category: { type: 'string', description: 'Top-level taxonomy category', example: 'Jewellery' },
            subcategory: { type: 'string', description: 'Must be a registered child of category', example: 'Mens' },
            tags: {
              type: 'array',
              items: { type: 'string' },
              description: 'Optional; a comma-separated string is also accepted. Full replacement on update.',
            },
            weight: { type: 'number', description: 'Grams. Required unless isFixedPrice is true.', example: 10 },
